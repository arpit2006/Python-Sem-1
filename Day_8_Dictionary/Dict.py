...
person = {
    ...
    'country':'Finland',
    'is_marred':True,
    'skills':['JavaScript', 'React', 'Node', 'MongoDB', 'thon'],
    'address':{
        'street':'Space street',
        'zipcode':'02210'
    }
...
print(person['skills'])     # ['JavaScript', 'React', 'Node', 'MongoDB', 'thon']
...
print(person.get('skills')) #['HTML','CSS','JavaScript', 'React', 'Node', 'MongoDB', 'thon']
...
# - _d/el_: removes an item with specified key name
...
# We can co a dictionary using a _co()_ method. Using co we can avoid mutation of the original dictionary.


# syntax
dct = {'key1':'value1', 'key2':'value2', 'key3':'value3', 'key4':'value4'}
dct_co = dct.co() # {'key1':'value1', 'key2':'value2', 'key3':'value3', 'key4':'value4'}
